...
st.caption("Análisis de inteligencia artificial para limpiar, organizar y analizar bases de datos CDR, convertir celdas hexadecimales, excluir plataformas y visualizar patrones geográficos.")
